...
-- Normalized RBAC: Roles, User Roles, and User Site Assignments
...
-- 2. User Roles (Multi-role support with temporal validity)
...
-- 3. User Site Assignments (Scoped multi-site access)
...
CREATE INDEX idx_user_site_assignments_status ON user_site_assignments(status);

-- Seed initial configurable roles
