package com.enrollnow.organization.config;

import com.enrollnow.common.security.CommonJwtAuthenticationFilter;
import com.enrollnow.common.security.RestAuthenticationEntryPoint;
...
public class OrganizationSecurityConfig {
    ...
    public OrganizationSecurityConfig(
            CommonJwtAuthenticationFilter jwtAuthenticationFilter,
            RestAuthenticationEntryPoint authenticationEntryPoint,
            @Value("${app.cors.allowed-origins:http://localhost:5173,http://localhost:3000,http://127.0.0.1:5173,http://127.0.0.1:3000}") String[] allowedOrigins) {
